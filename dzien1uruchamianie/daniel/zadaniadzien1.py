...
if lebork_friday_temp_c < boston_thursday_temp_c:
    ...
    print("Oooo, Panie, u nas w Lęborgu to zimno, ale to wszędy tak: mam wuja w Bostonie, i on mówi, że tam jest to samo, uciec donikąd, a kostucha blisko.")
...
print('W Lęborku w poniedziałek '+str(lebork_monday_temp_c)+u'\xb0C'+', a w Bostonie '+str(boston_monday_temp_c)+u'\xb0C')
print('W Lęborku we wtorek '+str(lebork_tuesday_temp_c)+u'\xb0C'+', a w Bostonie '+str(boston_tuesday_temp_c)+u'\xb0C')
print('W Lęborku w środę '+str(lebork_wednesday_temp_c)+u'\xb0C'+', a w Bostonie '+str(boston_wednesday_temp_c)+u'\xb0C')
print('W Lęborku w czwartek '+str(lebork_thursday_temp_c)+u'\xb0C'+', a w Bostonie '+str(boston_thursday_temp_c)+u'\xb0C')
print('W Lęborku w piątek '+str(lebork_friday_temp_c)+u'\xb0C'+', a w Bostonie '+str(boston_friday_temp_c)+u'\xb0C')
print('W Lęborku w sobotę '+str(lebork_saturday_temp_c)+u'\xb0C'+', a w Bostonie '+str(boston_saturday_temp_c)+u'\xb0C')
print('W Lęborku w niedzielę '+str(lebork_sunday_temp_c)+u'\xb0C'+', a w Bostonie '+str(boston_sunday_temp_c)+u'\xb0C')
...
average_temp_c_lebork_poland = (lebork_monday_temp_c + lebork_tuesday_temp_c + lebork_wednesday_temp_c + lebork_thursday_temp_c + lebork_friday_temp_c + lebork_saturday_temp_c + lebork_sunday_temp_c)/7

print('Average temperature in Lębork, Poland for the week is: '+ str(round(average_temp_c_lebork_poland,2))+u'\xb0C')
print('\n')
