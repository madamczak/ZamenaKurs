...
# print(url_validator("htps://ogloszenia.trojmiasto.pl/nieruchomosci-rynek-wtorny/mieszkanie-2-pokoje-gdynia-doskonala-inwestycja-ogl64070755.html"))
print(url_validator("https://hvdp.pl"))
